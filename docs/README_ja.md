...
- **サポートされているフォーマット:** `.docx`, `.doc`, `.pdf`, `.html`, `.xlsx`, `.xls`, `.xlm`, `.pptx`, `.odt`, `.odp`, `.ods`, `.rtf` (注意：レガシーフォーマット `.doc`, `.xls`, `.xlm` は名前変更エミュレーションを使用するため、正しく変換されない場合があります。)
...
![Webアプリ](../media/demo-pics/Markdown-them-Online-web-app.png)
![デスクトップアプリ](../media/demo-pics/Markdown-them-Desktop-app.png)
